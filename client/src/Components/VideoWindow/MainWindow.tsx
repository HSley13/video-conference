...
export const MainWindow = () => {
  ...
  return (
    <div className="flex flex-row h-screen relative">
      ...
      {/* <div className="ml-16 pr-4 pb-16 w-[calc(100vw-4rem)] h-screen overflow-hidden"> */}
      {/*   <VideoList /> */}
      {/* </div> */}
      {/**/}
      {/* <div className="fixed bottom-0 left-16 right-0 h-16 bg-gray-800 border-t border-gray-700"> */}
      {/* </div> */}
