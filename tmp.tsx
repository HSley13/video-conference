...
// ──────────────────────────────────────────────────────────────────────────────
//  AuthToggle –  "2022‑style" ✅  No React.FC, no separate interfaces; just
//  plain functions with the bare‑minimum inline typing that TS needs.
//
//  ▸ sign‑up form   → top‑left
//  ▸ sign‑in form   → bottom‑right
//  ▸ emerald blob   → symmetric; half‑circle slides L ⇄ R
//  ▸ pure Tailwind  → zero hand‑written CSS
// ──────────────────────────────────────────────────────────────────────────────
...
export default function AuthToggle() {
  ...
  // flip to sign‑in shortly after mount (tiny flourish)
  useEffect(() => {
